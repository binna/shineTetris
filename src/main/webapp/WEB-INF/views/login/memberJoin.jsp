				...
				<div class="sign-in-form">
					...
					<div>
						<form name="regform" id="regform" class="sign-in-reg-form" action="${path}/tetris/login/insert" method="post" onsubmit="return sendit()">
							...
							<p><label>아이디 : <input type="text" name="userid" id="user_id" maxlength="20"></label></p>
							<p><label>비밀번호 : <input type="password" name="userpw" id="user_pw" maxlength="20"></label></p>
							<p><label>비밀번호 확인 : <input type="password" name="userpw_re" id="WWuserpw_re" maxlength="20"></label></p>
							<p><label>이름 : <input type="text" name="username" id="user_name"></label></p>
					
							<!-- 이메일 인증 -->
							<p><label>이메일 : <input type="text" name="email" id="user_email" value="${mail}"></label>
							...
							<!-- 우편 API -->
							<p>우편번호 : <input type="text" name="zipcode" id="user_zipcode" disabled="disabled">
							&nbsp;<input type="button" id="adrBtn" value="우편번호 검색" onclick="sample6_execDaumPostcode()"></p>
							<p><label>주소 : <input type="text" name="address1" id="user_address"></label></p>
							<p><label>상세주소 : <input type="text" name="address2" id="user_address2"></label></p>
